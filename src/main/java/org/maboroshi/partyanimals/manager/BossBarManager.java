...
public class BossBarManager {
  ...
  public void createBossBar(
    ...
    BossBar bossBar =
        BossBar.bossBar(
            barName, 1.0f, pinataConfig.health.bar.color, pinataConfig.health.bar.overlay);
  ...
  public void updateBossBar(
    ...
    if (pinataConfig.timer.timeout.enabled) {
      ...
      int remaining =
          Math.max(0, totalTimeout - (int) ((System.currentTimeMillis() - spawnTime) / 1000));
  ...
  private void updateViewerList(
      LivingEntity pinata, BossBar bar, PinataConfiguration pinataConfig) {
