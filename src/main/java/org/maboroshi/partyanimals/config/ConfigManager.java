...
public class ConfigManager {
  ...
  public void saveConfig() {
    ...
    YamlConfigurations.save(
        settingsPath, MainConfiguration.class, mainConfig, ConfigLib.BUKKIT_DEFAULT_PROPERTIES);
  ...
  public void saveMessages() {
    ...
    YamlConfigurations.save(
        path, MessageConfiguration.class, messageConfig, ConfigLib.BUKKIT_DEFAULT_PROPERTIES);
  }
