...
public final class MainConfig {
  ...
  public static class CommunityGoalSettings {
    ...
    public CommunityGoalSettings() {
      this.rewards.put(
          "community_reward",
          new RewardAction(
              100.0, List.of("say <green>Community goal reached!", "pa spawn default spawn")));
    }
  }
  ...
  public static class VoteEvent {
    ...
    public Map<String, RewardAction> rewards =
        new HashMap<>(
            Map.of(
                "announce",
                new RewardAction(100.0, List.of("say <green>Thank you {player} for voting!"))));
  }
