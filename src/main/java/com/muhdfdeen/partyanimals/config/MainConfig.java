...
public final class MainConfig {
    ...
    public record PinataCooldownSettings(
            ...
            @Comment("If true, the cooldown is unique to each player. If false, it's server-wide.")
                    boolean perPlayer) {}
    ...
    public record PinataAISettings(
            ...
            @Comment("Pathfinding settings for the pinata.")
                    PinataPathfindingSettings pathfinding) {}

    public record PinataPathfindingSettings(
    ...
    public record PinataSettings(
            ...
            @Comment("Locations where pinatas can spawn.")
                    Map<String, SerializableLocation> spawnLocations,
    ...
    public static class MainConfiguration {
        ...
        public PinataSettings pinata =
                new PinataSettings(
                        new PinataAppearanceSettings(
                                List.of("LLAMA"), "<green>Pinata", new ScaleSettings(0.5, 1.5)),
                        new PinataDisplaySettings(
                                true, "GREEN", "PROGRESS", true, "RED", "PROGRESS"),
                        new PinataHealthSettings(10, true, 1),
                        new PinataCooldownSettings(0.75, true),
                        new PinataAISettings(
                                true,
                                1.0,
                                new PinataPathfindingSettings(
